package co.za.izinga.menuupdater.medirite;
...
public class MediriteToIzinga {
    ...
    public static boolean loadWWMenu(int page, WebDriver driver, Set<Stock> stockList) {
        ...
        driver.get("https://www.shoprite.co.za/c-2256/All-Departments?q=%3Arelevance%3AallCategories%3Amedicine%3AallCategories%3Avitamins%3AbrowseAllStoresFacetOff%3AbrowseAllStoresFacetOff&page=" + page);
